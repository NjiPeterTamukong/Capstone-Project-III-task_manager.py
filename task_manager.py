...
with open('user.txt', 'r') as username:
    ...
    # line in username file
    for line in username:

        # username , password is initialize to line.split(", ") which is removing new line characters and all the comma
        # and space (,) from username and password.
        username, password = line.split(",")

        # strip removes leading/trailing whitespaces
        # this step permit the addition of data in the dictionary
        users[username.strip()] = password.strip()
        #Nb: striping and spliting help to dismantle, before recontsruction in the in the users dictionary.
...
with open('user.txt', 'r') as password:
    ...
    for line in password:
        ...
        # username , password is initialize to line.split(", ") which is removing new line characters and comma
        # and space (,) from username and password
        username, password = line.split(",")
...
if (menu == "r" or menu == "R") and name == 'admin':
    ...
    # while new_password is not equall to new_password_confirm
